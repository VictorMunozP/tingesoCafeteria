...
public class mail implements Serializable {
    ...
    public void send() {
        try {
            ...
            mailSender.sendMail("cafeteria.mingeso@gmail.com", "cafeteria.mingeso@gmail.com", "cafeteriamingeso", "victor.munoz.pesce@gmail.com", "Detalle de orden", "Usted acaba de realizar una compra por: $"+message+". Su pedido será enviado a la dirección: "+direccion+" a las "+hora+" hrs. Método de pago: "+mpago+". Gracias por su compra.");
        } catch (Exception e) {
        }
    }
}
